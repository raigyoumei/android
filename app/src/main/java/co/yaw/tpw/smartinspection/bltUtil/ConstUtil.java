...
public class ConstUtil {
    ...
    public final static String RESP_DATA_KEY = "RESP_DATA_KEY";

    public final static String FORWARD_BEFORE_VALUE = "1";
    public final static String FORWARD_AFTER_VALUE = "2";
